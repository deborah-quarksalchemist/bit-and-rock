...
export function BitAndRock({ as: _Component = _Builtin.Block }) {
  ...
  return (
    <_Component className={_utils.cx(_styles, "intro-parent")} tag="div">
      <_Builtin.Block
      ...
      >
        ...
        <_Builtin.Block className={_utils.cx(_styles, "title")} tag="div">
          ...
          <_Builtin.Heading
            className={_utils.cx(_styles, "sub-title")}
            tag="h6"
          >
